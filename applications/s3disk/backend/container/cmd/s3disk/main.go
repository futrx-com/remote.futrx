...
// REQUIRED — every backend/container/cmd/<name> program needs package main and
// func main(). Remote derives the installed binary name from <name>.
func main() {
...
The service command is started by Remote's application service declaration.
